...
function renderizarProductos(productos, selectorContenedor) {
  ...
  let html = "";
  // Usamos forEach para poder pasar el 'index' (0, 1, 2) a la función
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 1. Pintamos las tres secciones de productos
  ...
  // 2. Añadimos la lógica para los botones de cantidad (+ / -)
  // Usamos "delegación de eventos" para que funcione en todas las tarjetas
